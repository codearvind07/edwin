...
const testimonials = [
  {
    ...
    quote:
      "The quality of consultation and after-service support from Edwin Corporate Law Firm has been exceptional. Their team responds promptly with solutions tailored to our challenges.",
    avatar:
      ...
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        >
          ...
          <p className="mt-4 text-base text-brand-navy/70">
            Hear how businesses leverage Edwin Corporate Law Firm for legal clarity, fiscal confidence, and intellectual property strength.
          </p>
        </motion.div>
